...
parser.add_argument('-O', '--output_name',    type=str, help='name of the output parquert file')
...
df = spark.read.parquet(args.input_tarred_file1)

af_columns = [c for c in df.columns if c.endswith("_AF")]
